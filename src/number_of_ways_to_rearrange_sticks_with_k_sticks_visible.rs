//! Solution for https://leetcode.com/problems/number-of-ways-to-rearrange-sticks-with-k-sticks-visible
    ...
    pub fn rearrange_sticks(n: i32, k: i32) -> i32 {
        ...
        for i in 1..=n {
            for j in 1..=k.min(i) {
                ...
                ndp += dp[i - 1][j - 1];
                ndp += dp[i - 1][j] * Num::new(i as u32 - 1);
                dp[i][j] = ndp;
            }
        }
        dp[n][k].val as i32
...
mod tests {
    ...
    #[case(3, 2, 3)]
    #[case(5, 5, 1)]
    #[case(20, 11, 647427950)]
    fn case(#[case] n: i32, #[case] k: i32, #[case] expected: i32) {
        let actual = Solution::rearrange_sticks(n, k);
