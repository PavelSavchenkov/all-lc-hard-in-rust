//! Solution for https://leetcode.com/problems/sum-of-subsequence-widths
//! 891. Sum of Subsequence Widths

impl Solution {
    pub fn sum_subseq_widths(mut a: Vec<i32>) -> i32 {
        let n = a.len();
        ...
        for i in 0..n {
            let left = pw2[i];
            ans += left * Num::new(a[i] as u32);
            let right = pw2[n - i - 1];
            ans -= right * Num::new(a[i] as u32);
        }
        ans.val as i32
    }
}
...
mod tests {
    ...
    fn case(#[case] nums: Vec<i32>, #[case] expected: i32) {
        let actual = Solution::sum_subseq_widths(nums);
