//! Solution for https://leetcode.com/problems/count-the-number-of-arrays-with-k-matching-adjacent-elements
...
impl Solution {
    pub fn count_good_arrays(n: i32, m: i32, k: i32) -> i32 {
        ...
        let mut ans = Num::new(m as u32) * Num::new(m as u32 - 1).pow(segs as u64 - 1);
        // binom(k + segs - 1, segs - 1)
        ans *= fact[k + segs - 1];
        ans /= fact[segs - 1];
        ans /= fact[k];
        ans.val as i32
...
mod tests {
    ...
    #[case(4, 2, 2, 6)]
    #[case(5, 2, 0, 2)]
    fn case(#[case] n: i32, #[case] m: i32, #[case] k: i32, #[case] expected: i32) {
        let actual = Solution::count_good_arrays(n, m, k);
